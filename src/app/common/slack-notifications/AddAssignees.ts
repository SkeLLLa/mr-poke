...
export class AddAsigneesNotification implements ISlackMessage {
  ...
  constructor(
    ...
    this.text = `Merge request ${options.mergeRequest.title} in <${options.project.url}|${options.project.name}> has no assignees. If you expect your MR to be merged, please add them.`;
    this.blocks = [
      {
        type: 'context',
        elements: [
      ...
      },
      {
        ...
        elements: [
          ...
          {
            type: 'mrkdwn',
            text: `Merge request has no assignees. If you expect your MR to be merged, please add them.`,
          },
        ],
      },
      {
